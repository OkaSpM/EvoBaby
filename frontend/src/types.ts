...
export interface StateResponse {
  ...
  merged_game?: { enabled: boolean; phase: string; complete: boolean; observation_window_turns?: number };
...
export interface CardMetric { spread: number; detect_turns: number | null; repair_turns: number | null; bad_actions: number }
